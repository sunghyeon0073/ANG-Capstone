...
// ── DocPreviewModal — 문서 미리보기 공용 모달 ──────────────────────────────
// 문서 렌더 공통 스타일 상수 (DocPreviewContent보다 먼저 선언)
...
function DocPreviewModal({ doc, open, onClose, onUseAsTemplate }) {
  if (!doc) return null;
  const author = userById(doc.author);
  return (
...
Object.assign(window, { Icon, Avatar, Pill, Btn, Card, SectionLabel, Input, AIBadge, Modal, Empty, FileTypeIcon, DocPreviewModal, DocPreviewContent });
