...
const TODAY = new Date(2026, 3, 20); // Apr 20, 2026 (month is 0-indexed)
...
Object.assign(window, {
  USERS, DEPTS, DOCS, EVENTS, TASKS, APPROVALS, BOARDS, CHATS, CHAT_MESSAGES, MAILS, NOTIFICATIONS,
  TODAY, userById, fmtDate, d
});
